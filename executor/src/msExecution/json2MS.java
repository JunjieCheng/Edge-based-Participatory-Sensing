...
public class json2MS {
	...
	public json2MS readDefaultFile(){
		String defaultFileName = "/users/cheng/SoftwareInnovationLab/edgeDSL/parser/jsonOutput.txt";
		return this.setJsonFile(defaultFileName);	
	}
	
	public json2MS readMSFile(String fileName){
		String defaultFileName = "/users/cheng/SoftwareInnovationLab/edgeDSL/parser/"+fileName;
		return this.setJsonFile(defaultFileName);	
	}
